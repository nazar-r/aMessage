    ...
    return (
        <>
            <div className="chat-page">
                ...
                <div className="chat-page__add-message" style={{ bottom: `calc(env(safe-area-inset-bottom, 0px) + 10px + ${keyboardOffset}px)`, zIndex: 1000, willChange: "bottom", transition: "bottom 0.2s ease" }}>
